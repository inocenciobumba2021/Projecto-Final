	...
	<div class="container">
		...
		<main>
			<div class="box">
				...
				<h2 class="txt-pedido">Produtos</h2>
				...
				<script>
					...
					$(document).ready(function() {
						produtos(pagina, qnt_resultado_pg);
						// Chamar a funcao para listar registros
					});

					function produtos(pagina, qnt_resultado_pg) {
						var dados = {
							pagina: pagina,
							qnt_resultado_pg: qnt_resultado_pg
						}
						var dados = $.post('controller/produtos.php', dados, function(retorna) {
