	...
	<div class="container">
		...
		<main>
			<div class="box">
				...
				<h2 class="txt-pedido">Pedidos</h2>

				<div class="box-table">
					<span class="listarVendas">
						<!--Aqui e aonde vai listar as todas as vendas finalizadas que foram recuperadas no documento carrinho.js da alinea 112 ate 128-->
					</span>
				</div>
				...
				<script>
					...
					$(document).ready(function() {
						pedidos(pagina, qnt_resultado_pg);
						// Chamar a funcao para listar registros
					});

					function pedidos(pagina, qnt_resultado_pg) {
						var dados = {
							pagina: pagina,
							qnt_resultado_pg: qnt_resultado_pg
						}
						var dados = $.post('controller/pedido.php', dados, function(retorna) {
	...
	<div class="modal-ver">
		...
		<div class="janela-modal-ver">
			...
			<table>
				...
				<tbody id="listaDados">
					<?php
					// include '../assets/controller/detalhes.php';
					?>
				</tbody>
			</table>
		</div>
