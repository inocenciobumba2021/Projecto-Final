	...
	<div class="container">
		...
		<main>
			<div class="box">
				...
				<h2 class="txt-pedido">Usuarios Cadastrados</h2>
				...
				<script>
					...
					$(document).ready(function() {
						tb_cliente(pagina, qnt_resultado_pg);
						// Chamar a funcao para listar registros
					});

					function tb_cliente(pagina, qnt_resultado_pg) {
						var dados = {
							pagina: pagina,
							qnt_resultado_pg: qnt_resultado_pg
						}
						var dados = $.post('controller/cliente.php', dados, function(retorna) {
