    ...
    <main>
      <div class="box">
        ...
        <div class="txt-pedido">
          <h2>Categorias</h2>
          <a href="nova_categoria.php" style="border-radius:10px">Nova Categoria</a>
        </div>
        ...
        <script>
          ...
          $(document).ready(function() {
            categoria(pagina, qnt_resultado_pg);
            // Chamar a funcao para listar registros
          });

          function categoria(pagina, qnt_resultado_pg) {
            var dados = {
              pagina: pagina,
              qnt_resultado_pg: qnt_resultado_pg
            }
            var dados = $.post('controller/categoria.php', dados, function(retorna) {
